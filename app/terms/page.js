  ...
  const sections = [
    {
      ...
      content: (
        <p>
          By accessing or using the Solomon Home Services website or any
          services provided through it, you agree to be bound by these Terms of
          Service ("Terms"), our Privacy Policy, and all applicable federal,
          state, and local laws and regulations. These Terms constitute a
          legally binding agreement between you and Solomon Home Services,
      ...
      content: (
        <>
          <p>
            ...
            <strong>REAL Broker, LLC</strong>, a Colorado licensed brokerage.
            All real estate activities, representations, and services are
            conducted in compliance with the Colorado Real Estate Commission
            (CREC) rules and the Colorado Revised Statutes governing real estate
            practice.
          </p>
          <p className="mt-3">
          ...
          <p className="mt-3">
            ...
            opinions based on available market data and are not formal
            appraisals. Only a licensed appraiser can provide a certified
            property appraisal.
          </p>
        </>
      ),
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside space-y-2 text-stone-600 mt-3">
            <li>MLS listing data is the intellectual property of the respective MLS and its participating members</li>
            <li>Listing information is deemed reliable but not guaranteed to be accurate, complete, or current</li>
            <li>Property information should be independently verified prior to entering any real estate transaction</li>
            <li>You may not reproduce, redistribute, or commercially exploit MLS data obtained through this website</li>
            <li>Listings may not reflect all properties available through the MLS</li>
          </ul>
          <p className="mt-3">
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside space-y-2 text-stone-600 mt-3">
            ...
            <li>Scrape, harvest, or collect data from this website through automated means</li>
            ...
            <li>Use the website to solicit, advertise, or promote competing real estate services without written consent</li>
            <li>Reproduce, republish, or distribute IDX listing content for commercial purposes</li>
          </ul>
          <p className="mt-3">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h4 className="font-semibold text-slate-800 mt-4 mb-2">What You May Do:</h4>
          <ul className="list-disc list-inside space-y-1 text-stone-600">
            <li>View and print pages for your personal, non-commercial real estate research</li>
            <li>Share links to this website through social media or email</li>
          </ul>
          <h4 className="font-semibold text-slate-800 mt-4 mb-2">What You May Not Do:</h4>
          <ul className="list-disc list-inside space-y-1 text-stone-600">
            <li>Reproduce, duplicate, copy, or sell any portion of the website without express written permission</li>
            <li>Use our trademarks, service marks, logos, or branding without prior written consent</li>
            <li>Create derivative works based on website content without authorization</li>
            <li>Use website content for any commercial purpose without written permission</li>
            <li>Remove or alter any copyright, trademark, or proprietary notices</li>
          </ul>
          <p className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg text-sm">
            <strong>DMCA Notice:</strong> If you believe that any content on this website infringes your copyright, please contact us at{" "}
            <a href="mailto:mark@solomonhomeservices.com" className="text-[#1e3a2f] font-medium hover:underline">
              mark@solomonhomeservices.com
            </a>{" "}
            with a description of the allegedly infringing material and its location on our site.
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          address and phone number provided. Submission of a contact form does
          not create an agency relationship, listing agreement, or any other
          binding real estate contract between you and Solomon Home Services or
          REAL Broker, LLC.
        </p>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-3">Solomon Home Services, Mark Solomon, and REAL Broker, LLC do not warrant that:</p>
          <ul className="list-disc list-inside space-y-1 text-stone-600 mt-2">
            ...
            <li>Property listing information is complete, accurate, or current</li>
            <li>Market analyses or home valuations will reflect actual sale prices</li>
            <li>Results obtained through use of our services will meet your expectations</li>
          </ul>
          <p className="mt-4">
            ...
            total liability to you for any claims arising under these Terms
            shall not exceed the amount you paid to us for services in the
            preceding 12 months.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <p>
          ...
          by federal, Colorado, or local law. Any discriminatory housing
          practices should be reported to the Colorado Civil Rights Division or
      ...
      content: (
        <>
          <p>
            ...
            arising out of or relating to these Terms or your use of this
            website shall be brought exclusively in the state or federal courts
            located in Colorado.
          </p>
          <p className="mt-3">
    ...
    },
    {
      ...
      content: (
        <>
          <p>Questions or concerns regarding these Terms of Service should be directed to:</p>
          <div className="mt-4 p-5 bg-[#1e3a2f]/8 rounded-lg border border-[#1e3a2f]/15">
            ...
            <a
              href="mailto:mark@solomonhomeservices.com"
              className="text-[#1e3a2f] font-medium hover:text-[#c9a84c] transition-colors block mt-1"
            >
              mark@solomonhomeservices.com
            </a>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mt-8 p-5 bg-[#1a2332] rounded-xl text-center">
          <p className="text-stone-400 text-xs leading-relaxed">
            Mark Solomon is a licensed Colorado real estate broker operating under{" "}
